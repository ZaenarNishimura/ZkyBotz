...
var xeonytimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "6283188229366") {
			let evaled,
				text = q,
...
m.reply(`Jangan Tag Dia!! Dia Sedang Afk ${reason ? 'Afk Karna: ' + reason : 'Tidak Di Ketahui'}
...
m.reply(`
Kamu Berhenti Afk ${user.afkReason ? ' Afk: ' + user.afkReason : ''}
...
const banRep = () => {
XeonBotInc.sendMessage(m.chat, {
text:`Kamu Telah Di Banned!!, Chat Wa @${creator.split("@")[0]} Untuk Unban`,
mentions: [creator],
},
{
quoted:m
